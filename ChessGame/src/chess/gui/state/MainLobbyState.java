...
public class MainLobbyState extends GUIState implements IJoinGameListener {
    ...
    private void initComponents() {
        ...
        sessionsListPanel = new chess.gui.component.SessionsListPanel();
        chatLog = new chess.gui.component.ChatLogPanel();
        logoutButton = new javax.swing.JButton();
        hostButton = new javax.swing.JButton();
        chatEntryField = new chess.gui.component.ChatEntryField();
        jTabbedPane1 = new javax.swing.JTabbedPane();
        playersListPanel = new chess.gui.component.DynamicListPanel();
        scoreboardListPanel = new chess.gui.component.DynamicListPanel();
        popupLayerPanel = new javax.swing.JPanel();
        popupFrame = new chess.gui.component.PopupFrame();
        ...
        sessionsListPanel.setEmptyMessage("No available game sessions");
        jSplitPane1.setLeftComponent(sessionsListPanel);

        chatLog.setEmptyMessage("No chat messages");
        ...
        playersListPanel.setItems(new String[] {});
        playersListPanel.setTitle("Online Players");
        jTabbedPane1.addTab("Online", playersListPanel);

        scoreboardListPanel.setTitle("Recent Winners");
        ...
        popupFrame.setBackground(javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionBackground"));
        popupFrame.setForeground(javax.swing.UIManager.getDefaults().getColor("CheckBoxMenuItem.selectionForeground"));
        popupFrame.setDialogBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        popupFrame.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                popupFrameActionPerformed(evt);
            }
        });
    ...
    private chess.gui.component.ChatLogPanel chatLog;
    ...
    private chess.gui.component.PopupFrame popupFrame;
    private javax.swing.JPanel popupLayerPanel;
    private chess.gui.component.DynamicListPanel scoreboardListPanel;
    private chess.gui.component.SessionsListPanel sessionsListPanel;
